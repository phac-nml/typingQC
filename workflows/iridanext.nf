...
workflow IRIDANEXT {
    ...
    // MODULE: MultiQC
    //
    workflow_summary    = WorkflowIridanext.paramsSummaryMultiqc(workflow, summary_params)
    ch_workflow_summary = Channel.value(workflow_summary)

    methods_description    = WorkflowIridanext.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description, params)
